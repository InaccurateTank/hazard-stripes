...
for i = 1, #ctypes, 1 do
    ...
    for d = 1, #dir, 1 do
        ...
        sta.variants.material_background.picture = "__hazard-stripes__/graphics/" .. ctypes[i] .. "/" .. ctypes[i] .. "-" .. dir[d].this .. ".png"
        sta.variants.material_background.hr_version.picture = "__hazard-stripes__/graphics/" .. ctypes[i] .. "/hr-" .. ctypes[i] .. "-" .. dir[d].this .. ".png"
        ...
        ref.variants.material_background.picture = "__hazard-stripes__/graphics/" .. ctypes[i] .. "/refined-" .. ctypes[i] .. "-" .. dir[d].this .. ".png"
        ref.variants.material_background.hr_version.picture = "__hazard-stripes__/graphics/" .. ctypes[i] .. "/hr-refined-" .. ctypes[i] .. "-" .. dir[d].this .. ".png"
